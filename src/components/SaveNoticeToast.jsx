...
const MESSAGES = {
  ...
  "reset-corrupted": {
    ...
    body: "Основний запис і резервна копія виявились пошкодженими, тож прогрес почався заново. Раджу час від часу тиснути «Експортувати прогрес» у налаштуваннях — так є власна копія на такий випадок.",
  },
};
