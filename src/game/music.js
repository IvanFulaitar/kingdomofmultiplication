...
// Було 0.35 — але виміряно (ffmpeg volumedetect), що "важливі" стінгери
// (victory/defeat/level_up тощо) самі по собі не гучніші за трек музики
// (усі приблизно -15..-18dB mean, як і музика). Проблема була суто в
// розриві множників: SFX грає з gain=0.3 (getSfxVolume), а притишена
// музика падала до 0.18×0.35=0.063 — різниця +13.6dB, тому стінгер
// відчутно "перебивав" музику. 0.5 разом із IMPORTANT_GAIN_SCALE у
// sfx.js (0.3×0.7=0.21 проти 0.18×0.5=0.09, тобто +7.4dB) дає помітний,
// але вже не оглушливий акцент.
const DUCK_MULT = 0.5; // наскільки приглушуємо на час звуку перемоги
